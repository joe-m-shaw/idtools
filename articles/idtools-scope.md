...
`idtools` is intended for pseudonymised identifiers, which is why
functions for working with NHS numbers, names or dates of birth are not
included.

## Could you add an `extract_patient_name` function?
